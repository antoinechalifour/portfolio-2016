export default [{
  ...
  img: 'asc.png',
  description: "Last year I joined the Atlantic Surf Cup as a communication manager, so I decided to build a new website and I was in charge of designing the posters."
}];